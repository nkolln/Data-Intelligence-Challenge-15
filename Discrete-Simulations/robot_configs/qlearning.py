...
def robot_epoch(robot):
    ...
    for i in range(200):
        ...
        for t in range(100):
            action = select_action(Q, state, True) #follow a policy to select action
            # take action 
            ...
            # choose next action     
            next_action = select_action(Q, next_state, False) #don't follow a policy, rather return argmax
            # update Q
